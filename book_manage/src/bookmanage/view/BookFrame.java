...
public class BookFrame extends JFrame implements ActionListener {
	...
	private JMenu menuManage, menuAbout;
	// 定义菜单项 图书列表 、关于、以及退出
	private JMenuItem itemList, itemBook, itemAbout, itemExit;
	//定义容器
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals("about")) {// 关于
			JOptionPane.showMessageDialog(BookFrame.this, "666");
		} else if (e.getActionCommand().equals("otherBtn")) {
			JOptionPane.showMessageDialog(BookFrame.this, "读者根据自己需求添加");
